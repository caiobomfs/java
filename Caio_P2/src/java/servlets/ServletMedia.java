...
try{
            ...
            rd = request.getRequestDispatcher("exibirResultado.jsp");
	...
	media.calcularMedia(a, b);
		...
		c = Float.parseFloat(c);                		media.calcularMedia(a, b, c);
                
            }     
	out.println("<span>" + m.getResultado() + "</span>");
	catch(IOException | NumberFormatException | ServletException e){
                out.println("<h3>Deu ERROR: " + e + ",</h3>");
            }
 }
    }
